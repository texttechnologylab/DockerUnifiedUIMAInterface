...
class Visualiser:
    ...
    def setDir(self, dirPath):
        ...
        # print(self.entries)
        self.local = dirPath+"/remote"
        self.l_websocket = dirPath+"/remote/ws_vs_rest"
        self.addTestsLocal()
        return
    ...
    def plotGradientDescent(self):
        ...
        plt.savefig('results/gradientDescent_remote_ws_vs_rest.pdf')
    ...
    def plot(self):
        ...
        plt.title(self.all[self.myindex]+": remote \n mit den ersten und letzten Wert\n Rest vs Websocket (100)", fontsize=40, fontweight="bold", pad=40)
        ...
        plt.savefig('results/plot_remote_ws_vs_rest.pdf')
