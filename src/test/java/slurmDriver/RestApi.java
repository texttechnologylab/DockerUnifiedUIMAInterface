...
//import org.texttechnologylab.DockerUnifiedUIMAInterface.driver.slurm.SlurmRestContainer;
...
//    {
//        try {
//            manager = ConfigManager.getManager(new File("src/main/resources/slurmDriverConf/slurmDriver.yaml"));
//        } catch (IOException e) {
//            throw new RuntimeException(e);
//        }
//    }
//
//    SlurmRestContainer slurmRestContainer = new SlurmRestContainer(manager,"");
//    SlurmRestContainer container = new SlurmRestContainer(manager,""
//
//    @Test
//    public void detect() throws IOException {
//
//        System.out.println(container.new ServiceDetector().detect());
//
//    }
//
//
...
//        boolean b = container.new ServiceDetector().detect();
//        System.out.println(b);
//        System.out.println(slurmRestContainer.containerNameID());
//        System.out.println(slurmRestContainer.showHostName());
//        List<String> strings = slurmRestContainer.listContainerNames();
...
//
//        String s = slurmRestContainer.generateTokenByHost("slurmctld");
//        System.out.println("=============================================================================");
//        System.out.println(slurmRestContainer.query(s, "diag"));
//        System.out.println("=============================================================================");
//        System.out.println(slurmRestContainer.query(s, "jobs"));
//        System.out.println("=============================================================================");
//
//
//    }
//
//    @Test
//    public void showRootToken() {
//        try {
//            System.out.println(slurmRestContainer.generateRootToken("slurmctld"));
//        } catch (IOException e) {
//            throw new RuntimeException(e);
...
//                .put("job", job);
//
//        String token = slurmRestContainer.generateRootToken("compute1");
//        Arrays.stream(slurmRestContainer.submit(token, payload)).forEach(System.out::println);
//    }
//
//    @Test
//    public void seeJobIDn() throws IOException, InterruptedException {
//        String s = slurmRestContainer.generateRootToken("compute1");
//        System.out.println("=============================================================================");
//        System.out.println(slurmRestContainer.query(s, "job/13"));
//    }
//
//    @Test
...
//        String token = slurmRestContainer.generateRootToken("compute1");
//        assert slurmRestContainer.cancelJob(token, "5");
//
//    }
//
//    @Test
...
//        String pass = ""
//        SlurmRestContainer rest = new SlurmRestContainer(manager,pass);
...
//        SlurmRestContainer rest = new SlurmRestContainer(manager);
//
//
//        int iWorkers = 2; //
//        JCas jc = JCasFactory.createText("Early life\n" +
