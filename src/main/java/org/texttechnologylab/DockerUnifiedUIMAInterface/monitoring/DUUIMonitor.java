...
public class DUUIMonitor {
    ...
    private static final char[] token = "specialtoken".toCharArray();
    private static final String org = "texttechnologylab";
    private String _url;
    private int _port;
    private static final String bucket_pipeline = "duui_pipeline";
    private WriteApi _writeAPI;
    private Duration _writeInterval;
    private static final String bucket_logs = "duui_logs";
