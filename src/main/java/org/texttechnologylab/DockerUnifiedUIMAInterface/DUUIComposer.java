                ...
                try {
                    ...
                    if (segmentationStrategy instanceof DUUISegmentationStrategyNone) {
                        ...
                        while (jCasSegmented != null) {
                            ...
                            if (segmentationStrategy instanceof DUUISegmentationStrategyByDelemiter pStrategie) {
...
public class DUUIComposer {
    ...
    private final AtomicBoolean _shutdownAtomic;
...
//                }
    ...
    public AtomicInteger getProgressAtomic() {
        return progress;
    }
