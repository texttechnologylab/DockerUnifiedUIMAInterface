...
public class DUUIArangoDBStorageBackend implements IDUUIStorageBackend {
    ...
    private final ArangoCollection _pipelineCollection;
    private final ArangoCollection _pipelineComponentCollection;
    private ArangoCollection _pipelineComponentEdge;

    private final ArangoCollection _pipelineComponentDocumentPerformance;
    private final ArangoCollection _pipelineDocumentPerformance;
    ...
    public void addNewRun(String name, DUUIComposer composer) throws SQLException {
        ...
        for (DUUIPipelineComponent comp : composer.getPipeline()) {
            ...
            if (base != null) {
                System.out.print("[DUUIArangoDBStorageBackend] Found existing pipeline component. Using existing component.\n");
