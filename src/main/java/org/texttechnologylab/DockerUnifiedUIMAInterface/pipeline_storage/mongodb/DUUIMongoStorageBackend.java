...
public class DUUIMongoStorageBackend implements IDUUIStorageBackend {

    private final boolean trackErrorDocs;
    private final MongoClient _client;

    public DUUIMongoStorageBackend(String connectionURI, boolean trackErrorDocs) {
        this.trackErrorDocs = trackErrorDocs;
        _client = MongoClients.create(connectionURI);
    }

    public DUUIMongoStorageBackend(String connectionURI) {
