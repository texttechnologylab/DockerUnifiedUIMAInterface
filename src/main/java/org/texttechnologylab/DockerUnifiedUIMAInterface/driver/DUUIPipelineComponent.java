...
public class DUUIPipelineComponent {
    ...
    private static final String engineOptionName = "engine";
    ...
    private static final String scaleOptionName = "scale";
    private static final String ignoring200 = "ignoring200";
    ...
    private static final String urlOptionName = "url";
    private static final String websocketOptionName = "websocket";
    final private static String workersOptionName = "workers";
    private static final String dockerPasswordOptionName = "dockerPassword";
    private static final String dockerUsernameOptionName = "dockerUsername";
    private static final String dockerNoShutdown = "dockerNoShutdown";
    private static final String dockerWithGPU = "dockerWithGPU";
    private static final String dockerImageName = "dockerImageName";
    private static final String dockerImageFetching = "dockerImageFetch";
    private static final String versionInformation = "version";
    private static final String writeToViewName = "uimaViewName";
    private static final String initialViewFromInitialViewName = "uimaViewInitializeFromInitial";
    private static final String componentName = "name";
    private static final String driverName = "driver";
    private static final String descriptionName = "description";
    private static final String sourceView = "sourceView";
    private static final String targetView = "targetView";
